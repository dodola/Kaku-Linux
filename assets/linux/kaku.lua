...
config.keys = {
  ...
  -- Ctrl+Shift+A: open Kaku AI settings in current pane
  {
    key = 'A',
    mods = 'CTRL|SHIFT',
  ...
  -- Ctrl+Shift+X: apply latest Kaku Assistant suggestion for the active pane
  {
    key = 'X',
    mods = 'CTRL|SHIFT',
  ...
  -- Ctrl+Shift+G: launch lazygit in current pane
  {
    key = 'G',
    mods = 'CTRL|SHIFT',
  ...
  -- Ctrl+Shift+Y: launch yazi in current pane
  {
    key = 'Y',
    mods = 'CTRL|SHIFT',
  ...
  -- Ctrl+Shift+S: Toggle split direction (horizontal <-> vertical)
  {
    key = 'S',
    mods = 'CTRL|SHIFT',
...
wezterm.on('gui-startup', function(cmd)
  ...
  if needs_update then
    ...
    local possible_paths = {
      "/usr/share/kaku/check_config_version.sh",
      "/usr/local/share/kaku/check_config_version.sh",
      home .. "/.local/share/kaku/check_config_version.sh",
      wezterm.executable_dir .. "/../share/kaku/check_config_version.sh",
      wezterm.executable_dir .. "/../../assets/shell-integration/check_config_version.sh",
    }
